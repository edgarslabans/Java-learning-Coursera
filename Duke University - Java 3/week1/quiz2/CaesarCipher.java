...
public class CaesarCipher {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Cypher " + m.encrypt("Can you imagine life WITHOUT the internet AND computers in your pocket?", 15));
        System.out.println("Cypher " + m.encryptTwoKeys("Can you imagine life WITHOUT the internet AND computers in your pocket?", 21,8));
        
        System.out.println("Q6 " + m.encryptTwoKeys("Hfs cpwewloj loks cd Hoto kyg Cyy.", 12,2));
        System.out.println("Q7 " + m.encryptTwoKeys("Aal uttx hm aal Qtct Fhljha pl Wbdl. Pvxvxlx!", 19,7));
        System.out.println("Q8 Duke Computer Science Department Overview");

        FileResource resource = new FileResource("data/mysteryTwoKeysQuiz.txt");
        String res = resource.asString();
        
        System.out.println("Encrypt2: " + m.encryptTwoKeys(res, 9,22));
    }
